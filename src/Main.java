public class Main {
    public static void main(String[] args) {
        Move CloseCombat = new PhysicalMove("Close Combat", Type.FIGHTING, 120, 100, 5, Effect.LOWERDEFENCES,1);
        ...
        Pokemon Infernape = new Pokemon(392,"Infernape", Type.FIRE, Type.FIGHTING, 5, StatusEffect.NONE, 269, 254, 200,254,200,260,InfernapeMoves);
        Pokemon Garchomp = new Pokemon(445,"Garchomp", Type.DRAGON, Type.GROUND, 5, StatusEffect.NONE, 317, 297, 239,214,223,250,GarchompMoves);
        Pokemon Luxray = new Pokemon(405,"Luxray", Type.ELECTRIC, null, 5, StatusEffect.NONE, 25, 280, 213,239,213,198,LuxrayMoves);
        Pokemon Staraptor = new Pokemon(398,"Staraptor", Type.NORMAL, Type.FLYING, 5, StatusEffect.NONE, 283, 280, 198,165,181,247,StaraptorMoves);
        Pokemon Sceptile = new Pokemon(254,"Sceptile", Type.GRASS, null, 5, StatusEffect.NONE, 260, 223, 190,256,223,2890,SceptileMoves);
        Pokemon Gyarados = new Pokemon(130,"Gyarados", Type.WATER, Type.FLYING, 5, StatusEffect.NONE, 274, 220, 247,223,256,211,GyaradosMoves);
        
        Pokemon Blastoise = new Pokemon(9,"Blastoise", Type.WATER, null, 5, StatusEffect.NONE, 299, 254, 298,254,298,198,BlastoiseMoves);
        Pokemon Alakazam = new Pokemon(65,"Alakazam", Type.PSYCHIC, null, 5, StatusEffect.NONE, 238, 165, 157,305,239,280,AlakazamMoves);
        Pokemon Electevire = new Pokemon(466,"Electevire", Type.ELECTRIC, null, 5, StatusEffect.NONE, 268, 286, 193,239,223,239,ElectevireMoves);
        Pokemon Pidgeot = new Pokemon(18,"Pidgeot", Type.NORMAL, Type.FLYING, 5, StatusEffect.NONE, 280, 214, 206,198,198,249,PidgeotMoves);
        Pokemon Arcanine = new Pokemon(59,"Arcanine", Type.FIRE, null, 5, StatusEffect.NONE, 290, 264, 214,247,214,239,ArcanineMoves);
        Pokemon Nidoking = new Pokemon(34,"Nidoking", Type.POISON, Type.GROUND, 5, StatusEffect.NONE, 277, 250, 210,223,206,223,NidokingMoves);
