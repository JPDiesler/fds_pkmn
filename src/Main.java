public class Main {
    public static void main(String[] args) {
        ...
        Pokemon Blastoise = new Pokemon(9, "Blastoise", Type.WATER, null, 5, StatusEffect.NONE, 299, 254, 298, 254, 298,
                198, BlastoiseMoves);
        Pokemon Alakazam = new Pokemon(65, "Alakazam", Type.PSYCHIC, null, 5, StatusEffect.NONE, 238, 165, 157, 305,
                239, 280, AlakazamMoves);
        Pokemon Electevire = new Pokemon(466, "Electevire", Type.ELECTRIC, null, 5, StatusEffect.NONE, 268, 286, 193,
                239, 223, 239, ElectevireMoves);
        Pokemon Pidgeot = new Pokemon(18, "Pidgeot", Type.NORMAL, Type.FLYING, 5, StatusEffect.NONE, 280, 214, 206, 198,
                198, 249, PidgeotMoves);
        Pokemon Arcanine = new Pokemon(59, "Arcanine", Type.FIRE, null, 5, StatusEffect.NONE, 290, 264, 214, 247, 214,
                239, ArcanineMoves);
        Pokemon Nidoking = new Pokemon(34, "Nidoking", Type.POISON, Type.GROUND, 5, StatusEffect.NONE, 277, 250, 210,
